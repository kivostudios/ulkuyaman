...
import { categories, getBestsellers, getNewProducts } from "@/lib/data";
    ...
    <>
      ...
      <section className="relative h-[90vh] min-h-[560px] bg-gray-100 overflow-hidden">
        <Image
          ...
          alt="Ülkü Yaman Collection - Yeni Koleksiyon"
          fill
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-10 md:px-20">
          ...
          <h1 className="text-white text-5xl md:text-7xl font-light leading-tight max-w-lg">
            Hakiki<br />
            <span className="font-semibold">Deri ile</span><br />
            Şıklık
          </h1>
          <p className="text-white/80 mt-5 max-w-sm text-base leading-relaxed">
            Her adımda kalite. El işçiliğiyle üretilen hakiki deri koleksiyonumuz şimdi yayında.
          </p>
          <div className="flex gap-4 mt-8 flex-wrap">
            <Link
              href="/kategori/sandaletler"
              className="bg-white text-black px-8 py-3 text-sm tracking-widest uppercase font-semibold hover:bg-gray-100 transition-colors"
            >
              Koleksiyonu Keşfet
            </Link>
            <Link
              href="/hakkimizda"
              className="border border-white text-white px-8 py-3 text-sm tracking-widest uppercase font-semibold hover:bg-white/10 transition-colors"
            >
              Hakkımızda
            </Link>
          </div>
      ...
      <section className="max-w-[1400px] mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {categories.slice(0, 6).map((cat, i) => (
            ...
            >
              <div className={`relative img-hover ${i === 0 ? "aspect-[16/9]" : "aspect-[4/3]"}`}>
                <Image
                  src={cat.image}
                  alt={cat.name}
                  fill
                ...
                <div className="absolute bottom-6 left-6">
                  <h3 className={`text-white font-semibold tracking-wide ${i === 0 ? "text-2xl" : "text-lg"}`}>
                    {cat.name}
                  </h3>
      ...
      <section className="relative h-[60vh] min-h-[400px] overflow-hidden">
        <Image
          src="https://images.unsplash.com/photo-1515347619252-60a4bf4fff4f?w=1600&q=85"
          alt="Yaz İndirimi"
          fill
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          <p className="text-white/70 text-xs tracking-[0.4em] uppercase mb-3">Sınırlı Süre</p>
          <h2 className="text-white text-4xl md:text-6xl font-light mb-4">
            Yaz İndirimi
          </h2>
          <p className="text-white/80 text-sm mb-8 max-w-xs">
            Seçili ürünlerde %30&apos;a varan indirim fırsatını kaçırmayın.
          </p>
          <Link
            href="/kategori/sandaletler"
            className="border border-white text-white px-10 py-3 text-sm tracking-widest uppercase hover:bg-white hover:text-black transition-colors font-semibold"
          >
            Fırsatları Keşfet
          </Link>
        </div>
      ...
      <section className="max-w-[1400px] mx-auto px-6 pb-20">
        <div className="grid md:grid-cols-2 gap-0">
          <div className="relative aspect-square bg-gray-100 img-hover">
            <Image
              src="https://images.unsplash.com/photo-1596703263926-eb0762ee17e4?w=800&q=85"
              alt="Hakiki Deri"
              fill
              className="object-cover"
              sizes="50vw"
          ...
          <div className="bg-stone-50 flex flex-col justify-center px-10 md:px-16 py-16">
            ...
            <h2 className="text-4xl font-light leading-snug mb-6">
              Hakiki Deri.<br />
              <span className="font-semibold">Gerçek Kalite.</span>
            </h2>
            <p className="text-gray-600 leading-relaxed text-sm mb-8">
              Ülkü Yaman Collection olarak her ürünümüzü sertifikalı hakiki deri ile
              üretiyoruz. El işçiliğinin ustalığı ve modern tasarımın zarafetini
              bir araya getirerek ayağınıza mükemmeliyeti sunuyoruz.
            </p>
            <ul className="space-y-3 mb-8">
              {[
                "Sertifikalı hakiki deri malzeme",
                "14 gün değişim garantisi",
                "90 gün koşulsuz iade",
                "Türk ustalığı, uluslararası kalite",
              ].map((item) => (
            ...
            <Link
              href="/hakkimizda"
              className="inline-flex items-center gap-2 text-sm font-semibold tracking-wider uppercase border-b border-black pb-1 hover:opacity-60 transition-opacity w-fit"
            >
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-[1400px] mx-auto px-6 text-center">
          <p className="text-xs tracking-[0.4em] text-gray-500 uppercase mb-2">Sosyal Medya</p>
          <h2 className="text-2xl font-light mb-2">@ulkuyamancollection</h2>
          <p className="text-sm text-gray-500 mb-10">Instagram&apos;da bizi takip edin</p>
          <div className="grid grid-cols-3 md:grid-cols-6 gap-2">
            {[
              ...
              <a
                ...
                className="relative aspect-square img-hover bg-gray-200 overflow-hidden block"
              >
                <Image
                  src={src}
                  alt={`Instagram ${i + 1}`}
